...
CREATE TABLE `nominate` (
  ...
  CONSTRAINT `scholarship_id` FOREIGN KEY (`scholarship_id`) REFERENCES `scholarship` (`scholarship_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
LOCK TABLES `nominate` WRITE;
/*!40000 ALTER TABLE `nominate` DISABLE KEYS */;
INSERT INTO `nominate` VALUES (103005,112877,123123);
/*!40000 ALTER TABLE `nominate` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-04-14 20:20:58
